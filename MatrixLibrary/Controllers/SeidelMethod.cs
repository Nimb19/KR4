...
namespace Lab5Var9
{
    static public class SeidelAlgorithm
    {
        /// <summary>
        /// Находит ответы к матрице.
        /// </summary>
        /// <param name="a"></param>
        /// <param name="b"></param>
        /// <param name="eps"> Дельта. </param>
        /// <returns></returns>
        public static double[] Find_4x5(double[,] a, double[] b, double eps = 0.00001)
        {
            double[,] A = OddsSorting(a, b);
        ...
        private static double[,] OddsSorting(double[,] a, double[] b) // Сортируем матрицу
        {
